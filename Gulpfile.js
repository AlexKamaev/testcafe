...
function testFunctional (src, testingEnvironmentName, { disableMultipleWindows, experimentalCompilerService } = {}) {
...
gulp.step('test-functional-local-multiple-windows-run', () => {
    return testFunctional(MULTIPLE_WINDOWS_TESTS_GLOB, functionalTestConfig.testingEnvironmentNames.localChrome, { disableMultipleWindows: false });
});
