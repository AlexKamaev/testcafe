    ...
    describe('Init', () => {
        describe('Exists', () => {
            ...
            describe('Screenshot options', () => {
                ...
                it('Screenshot options integration test', () => {
