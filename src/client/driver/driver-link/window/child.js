import { CloseAllChildWindowsMessage, FindDriverMessage, SetAsMasterMessage } from '../messages';
...
export default class ChildWindowDriverLink {
    ...
    searchChildWindows (windowId) {
        const msg = new FindDriverMessage(windowId);
