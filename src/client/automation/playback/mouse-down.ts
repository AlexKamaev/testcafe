...
export default class MouseDownAutomation extends VisibleElementAutomation {
    ...
    public eventArgs: EventArgs123;
    public eventState: MouseDownStateController;

    public constructor (element: HTMLElement, clickOptions: ClickOptions, eventArgs: EventArgs123) {
    ...
    private _raiseTouchEvents (eventArgs: EventArgs123): void {
    ...
    private _mousedown (eventArgs: EventArgs123): Promise<unknown> {
    ...
    private _focus (eventArgs: EventArgs123): Promise<void> {
        if (this.eventState.simulateDefaultBehavior === false)
