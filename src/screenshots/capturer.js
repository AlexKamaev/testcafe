...
import { cropScreenshotBinary, cropScreenshotByPath } from './crop';
...
import { deleteFile, stat } from '../utils/promisified-functions';
import { writePng } from '../utils/png';
...
export default class Capturer {
    ...
    async _capture (forError, { pageDimensions, cropDimensions, markSeed, customPath } = {}) {
        ...
        await addToQueue(screenshotPath, async () => {
            ...
            try {
                const croppedImage = await cropScreenshotByPath(screenshotPath, markSeed, Capturer._getClientAreaDimensions(pageDimensions), Capturer._getCropDimensions(cropDimensions, pageDimensions));
