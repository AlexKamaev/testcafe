...
export default {
    ...
    cannotRunAgainstDisconnectedBrowsers:                             'The following browsers disconnected: {userAgents}. Tests will not be run.',
    cannotEstablishBrowserConnection:                                 'Unable to establish one or more of the specified browser connections. This can be caused by network issues or remote device failure.',
    cannotFindBrowser:                                                'Unable to find the browser. "{browser}" is not a browser alias or path to an executable file.',
    ...
    cannotFindReporterForAlias:                                       'The provided "{name}" reporter does not exist. Check that you have specified the report format correctly.',
    ...
    cannotFindSpecifiedTestSource:                                    'Cannot find a test source file at "{path}".',
    ...
    testControllerProxyCannotResolveTestRun:                          `Cannot implicitly resolve the test run in the context of which the test controller action should be executed. Use test function's 't' argument instead.`,
    timeLimitedPromiseTimeoutExpired:                                 'Timeout expired for a time limited promise.',
    cannotUseScreenshotPathPatternWithoutBaseScreenshotPathSpecified: 'Cannot use the screenshot path pattern without a base screenshot path specified.',
